...
<head>
    ...
    <title>Rega Komputer | Produk</title>
            ...
            <ul class="list-group">
                ...
                <?php while($kategori = mysqli_fetch_array($queryKategori)){ ?>
                    <a class="no-decoration" href="produk.php?kategori=<?php echo $kategori['nama'] ?>">
                        <li class="list-group-item warna1 text-light"><?php echo $kategori['nama'] ?></li>
                    </a>
                <?php } ?>
            </ul>
            </div>
            <div class="col-lg-9">
                <h3 class="text-center mb-3 text-light">Produk</h3>
                <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="produk-detail.php?nama=<?php echo $produk['nama']; ?>" class="btn btn-outline-secondary">Lihat Detail</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
